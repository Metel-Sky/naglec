...
class _CityViewState extends State<CityView> {
  ...
  Widget build(BuildContext context) {
    ...
    final roomData = LocationsData.cityRooms[widget.currentRoom];
  ...
  /// Сітка 6 слотів ТРЦ (2×3). Слоти на весь блок.
  ...
  /// Сітка 6 слотів єлітного ЖК (2×3): Квартира 1–6. Слоти на весь блок.
