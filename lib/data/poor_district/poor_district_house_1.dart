...
/// Будинок 1 у спальних будинках бідного району: 4 квартири, по 4 кімнати.
class PoorDistrictHouse1 {
  static const String id = 'poor_district_house_1';

  static const String apt1 = 'poor_district_h1_apt_1';
  static const String apt2 = 'poor_district_h1_apt_2';
  static const String apt3 = 'poor_district_h1_apt_3';
  static const String apt4 = 'poor_district_h1_apt_4';

  static const List<String> apartmentIds = [apt1, apt2, apt3, apt4];

  static const String rA1_1 = 'poor_district_h1_a1_room_1';
  static const String rA1_2 = 'poor_district_h1_a1_room_2';
  static const String rA1_3 = 'poor_district_h1_a1_room_3';
  static const String rA1_4 = 'poor_district_h1_a1_room_4';
  static const String rA2_1 = 'poor_district_h1_a2_room_1';
  static const String rA2_2 = 'poor_district_h1_a2_room_2';
  static const String rA2_3 = 'poor_district_h1_a2_room_3';
  static const String rA2_4 = 'poor_district_h1_a2_room_4';
  static const String rA3_1 = 'poor_district_h1_a3_room_1';
  static const String rA3_2 = 'poor_district_h1_a3_room_2';
  static const String rA3_3 = 'poor_district_h1_a3_room_3';
  static const String rA3_4 = 'poor_district_h1_a3_room_4';
  static const String rA4_1 = 'poor_district_h1_a4_room_1';
  static const String rA4_2 = 'poor_district_h1_a4_room_2';
  static const String rA4_3 = 'poor_district_h1_a4_room_3';
  static const String rA4_4 = 'poor_district_h1_a4_room_4';
  ...
  static const Map<String, RoomData> rooms = {
    ...
    apt2: RoomData(
      displayName: "Квартира 2 — Flaxy",
      imagePath: "lib/assets/location/houses/hrushchevki-spb.jpg",
      description: "Квартира 2, Бандери 1. Тут живе Flaxy.",
      isLocked: false,
    ),
    apt3: RoomData(
    ...
    apt4: RoomData(
      ...
      imagePath: "lib/assets/location/houses/hrushchevki-spb.jpg",
      description: "Квартира 4, Бандери 1.",
      isLocked: false,
    ),
    ...
    rA1_4: RoomData(displayName: "Спальня Luda", imagePath: "lib/assets/location/home_gg/rooms/room_gg.jpg", description: "Спальня.", isLocked: false),
    ...
    rA2_4: RoomData(displayName: "Спальня Flaxy", imagePath: "lib/assets/location/houses/ount_flaxy_badroom.jpeg", description: "Спальня Flaxy.", isLocked: false),
    ...
    rA3_4: RoomData(displayName: "Спальня Peta", imagePath: "lib/assets/location/home_gg/rooms/room_gg.jpg", description: "Спальня.", isLocked: false),
