...
class PoorDistrictHouse2 {
  ...
  static const Map<String, RoomData> rooms = {
    ...
    apt2: RoomData(
      ...
      imagePath: "lib/assets/location/houses/hrushchevki-spb.jpg",
      description: "Квартира 2, Бандери 2.",
      isLocked: false,
    ),
    apt3: RoomData(
    ...
    rA1_4: RoomData(displayName: "Спальня Kyler", imagePath: "lib/assets/location/home_gg/rooms/room_gg.jpg", description: "Спальня.", isLocked: false),
    ...
    rA2_4: RoomData(displayName: "Спальня", imagePath: "lib/assets/location/home_gg/rooms/room_gg.jpg", description: "Спальня квартири 2, Бандери 2.", isLocked: false),
    ...
    rA3_4: RoomData(displayName: "Спальня Foxy", imagePath: "lib/assets/location/home_gg/rooms/room_gg.jpg", description: "Спальня квартири 3, Бандери 2. Тут живе Foxy.", isLocked: false),
